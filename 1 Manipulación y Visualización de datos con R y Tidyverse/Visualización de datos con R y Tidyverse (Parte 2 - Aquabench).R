...
### MANIPULACIÓN Y VISUALIZACIÓN DE DATOS CON R Y TIDYVERSE (PARTE 2)      -----
### 
### Autor: Amadeo Guzmán
###~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#Vamos a obteneralguna información que usaremos más adelante...
#semana actual
...
(graf_calor_mz <- serie.SRS %>% 
   ...
   theme_minimal() +
   theme(strip.background = element_rect(fill = "grey50", color="grey99"),
